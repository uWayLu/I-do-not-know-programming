...
----------------------------------------------------------------------*/
define("MYSQL_ADDRESS", "127.0.0.1");          // Define the IP address of your MySQL Server
define("MYSQL_USERNAME", "root");         // Define your MySQL user name
define("MYSQL_PASSWORD", "unreal9527");         // Define your MySQL password
define("DATABASE", "localhost_uway_practice");               // Define your default database
