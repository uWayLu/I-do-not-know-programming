...
----------------------------------------------------------------------*/
define("MYSQL_ADDRESS", "mysql6.000webhost.com");          // Define the IP address of your MySQL Server
define("MYSQL_USERNAME", "a6839219_uway");         // Define your MySQL user name
define("MYSQL_PASSWORD", "kaoune2014");         // Define your MySQL password
define("DATABASE", "a6839219_kaoune");               // Define your default database
...
function connect_to_database()
	{
	$link = mysql_connect(MYSQL_ADDRESS, MYSQL_USERNAME, MYSQL_PASSWORD);
	return($link);
	mysqli_query($link, "SET NAMES 'utf8'"); # ¨Ï¥Îutf-8³s½u 
	}
